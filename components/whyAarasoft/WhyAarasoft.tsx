        ...
        <WhyAarasoftContainer>
            <CardsGrid>
                ...
                >
                    ...
                    <CardTitle $textColor={cardsData[0].textColor}>
                        {cardsData[0].title}
                    </CardTitle>
                </Card>
                ...
                <CenterColumn>
                    <TitleSection>
                        <Title>
                            Why
                            <span className="highlight"> Aarasoft</span><br/>
                            Academy?
                        </Title>
                    ...
                    <CenterCardsRow>
                        ...
                        >
                            ...
                            <CardTitle $textColor={cardsData[1].textColor}>
                                {cardsData[1].title}
                            </CardTitle>
                        </Card>
                        ...
                        >
                            <ContactCardContent>
                                ...
                                <CardTitle $textColor={cardsData[2].textColor}>
                                    {cardsData[2].title}
                                </CardTitle>
                            </ContactCardContent>
                        </Card>
                ...
                >
                    ...
                    <CardTitle $textColor={cardsData[3].textColor}>
                        {cardsData[3].title}
                    </CardTitle>
                </Card>
            </CardsGrid>
